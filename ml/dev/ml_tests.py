...
#from ml.management.commands.ml_train import foo
...
#     nb_vids, nb_users, vids_per_user = 5, 3, 4

#     #glob = fake_glob_scores(4)
...
#     #                                             resume=False, 
#     #                                             verb=-1)
#     # assert len(glob_scores) == 5
#     # assert len(contributor_scores) == 6 * 3
